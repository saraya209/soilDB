...
tic("Total Time")
tic("new code")
mu = get_data_from_NASIS(table.name = 'mapunit')
toc()
tic("new code")
comp = get_data_from_NASIS(table.name = 'component')
toc()
tic("new code")
hor = get_data_from_NASIS(table.name = 'chorizon')
toc()
tic("old code")
mu2 = get_mapunit_from_NASIS() 
toc()
toc()
